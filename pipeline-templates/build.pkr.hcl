...
source "vsphere-iso" "win-2022-std-core" {
  ...
  floppy_content = {
    ...
    // HTTP Settings
  http_directory       = var.default_http_directory
  http_port_min        = var.default_http_port_min
  http_port_max        = var.default_http_port_max
  http_ip              = var.default_http_ip
...
source "vsphere-iso" "win-2022-dc-core" {
  ...
  // VM Settings
  vm_name        = "${var.vm_guest_os_family}-${var.vm_guest_os_name}-${var.vm_guest_os_version}-${var.vm_guest_os_edition_datacenter}-${var.vm_guest_os_experience_core}"
  CPUs            = var.default_CPUs
  RAM             = var.default_RAM
  firmware             = var.default_firmware
  vm_version     = var.default_vm_version
  ...
  // Content Library Settings
    content_library_destination {
    name    = "${var.vm_guest_os_family}-${var.vm_guest_os_name}-${var.vm_guest_os_version}-${var.vm_guest_os_edition_datacenter}-${var.vm_guest_os_experience_core}"
    library = var.default_content_library_destination
    destroy = var.default_library_vm_destroy
    ovf     = var.default_ovf
  }
}
source "vsphere-iso" "win-2022-dc-dexp" {
  ...
  // VM Settings
  vm_name        = "${var.vm_guest_os_family}-${var.vm_guest_os_name}-${var.vm_guest_os_version}-${var.vm_guest_os_edition_datacenter}-${var.vm_guest_os_experience_desktop}"
  CPUs            = var.default_CPUs
  RAM             = var.default_RAM
  firmware             = var.default_firmware
  vm_version     = var.default_vm_version
  ...
  // Content Library Settings
    content_library_destination {
    name    = "${var.vm_guest_os_family}-${var.vm_guest_os_name}-${var.vm_guest_os_version}-${var.vm_guest_os_edition_datacenter}-${var.vm_guest_os_experience_desktop}"
    library = var.default_content_library_destination
    destroy = var.default_library_vm_destroy
    ovf     = var.default_ovf
  }
...
source "vsphere-iso" "win-2019-std-dexp" {
...
source "vsphere-iso" "win-2019-dc-core" {
...
source "vsphere-iso" "win-2019-dc-dexp" {
...
build {
  sources = ["source.vsphere-iso.win-2022-dc-core"]
...
build {
  sources = ["source.vsphere-iso.win-2022-dc-dexp"]
...
build {
  sources = ["source.vsphere-iso.win-2019-std-dexp"]
...
build {
  sources = ["source.vsphere-iso.win-2019-dc-core"]
...
build {
  sources = ["source.vsphere-iso.win-2019-dc-dexp"]
